    ...
    <div className="film-list-container">
      {movieList.length > 0 ? (
        movieList.map((item, index) => {
          ...
          const filmPoster = item.poster_url
            ? `${process.env.REACT_APP_API_URL}${item.poster_url}`
            : "/default-poster.jpg";
          const filmTrailer = item.trailer_url
            ? `${process.env.REACT_APP_API_URL}${item.trailer_url}`
            : null;
          ...
          return (
            ...
            >
              <div className="film-thumbnail">
                ...
                {filmTrailer && hoveredIndex === index && (
                  <video
                    loop
                    autoPlay
                    muted
                ...
                {!isMyList ? (
                  ...
                  <div
                    ...
                    // onClick={(e) => handleRemoveFromWishlist(filmId, index, e)}
                  >
                    <FaTimes />
                  </div>
                )}
                ...
                <div className="film-meta">
                  ...
                  <div className="film-release-runtime">
                    <span className="film-release">
                      {" "}
                      {item.release_date || "Không có ngày"}
                    </span>
