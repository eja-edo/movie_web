        ...
        <div className="display_show" id="show1">
            ...
            <div className="show_display_list" ref={showDisplayListRef}>
                <a href="#" onClick={(e) => { e.preventDefault(); navigate('/'); }}>
                    <img src={`${process.env.REACT_APP_API_URL}/static/assets/img/9ex8qx1n_7nam_hb_web_2388_458.jpg`} alt="" />
                </a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigate('/'); }}>
                    <img
                        src={`${process.env.REACT_APP_API_URL}/static/assets/img/au1qvk6a_homebanner_khanhdunienweb_2388x3712_2388_458.jpg`}
                        alt=""
                    />
                </a>
                <a href="#" onClick={(e) => { e.preventDefault(); navigate('/'); }}>
                    <img
                        src={`${process.env.REACT_APP_API_URL}/static/assets/img/kmmab8k0_web18ce19a0c0167a03a57e2b4bd93f5dd15_2388_458.jpg`}
                        alt=""
                    />
                </a>
            </div>
