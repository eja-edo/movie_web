...
from .models import Movies, Episodes, Movieactors, Moviedirectors
...
def movie_statistics(request):
    ...
    return render(request, 'admin/movies/reports/movie_statistics.html', context)
...
def episode_statistics(request):
    ...
    return render(request, 'admin/movies/reports/episode_statistics.html', context)
...
def actor_statistics(request):
    ...
    return render(request, 'admin/movies/reports/actor_statistics.html', context)
...
def director_statistics(request):
    ...
    return render(request, 'admin/movies/reports/director_statistics.html', context)
...
def comment_statistics(request):
    ...
    return render(request, 'admin/movies/reports/comment_statistics.html', context)
...
def dashboard(request):
    ...
    return render(request, 'admin/movies/reports/dashboard.html', context)
