...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Bạch Nguyệt Phạn Tinh'), 1, 37, '\hls/Bạch Nguyệt Phạn Tinh/epi_num1/master.m3u8');
