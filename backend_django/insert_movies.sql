...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Blue Block'), 1, 25, 'http://localhost:8080\media\normal\Blue Block\Blue Block.mp4');
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Breaking Bad'), 1, 58, 'http://localhost:8080\media\normal\Breaking Bad\Breaking Bad.mp4');
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Bạn bè cạnh tranh'), 1, 28, 'http://localhost:8080\media\normal\Bạn bè cạnh tranh\Bạn bè cạnh tranh.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Chàng Thư Ký Hoàn Hảo Của Tôi'), 1, 80, 'http://localhost:8080\media\normal\Chàng Thư Ký Hoàn Hảo Của Tôi\Chàng Thư Ký Hoàn Hảo Của Tôi.mp4');
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Chưởng Tâm'), 1, 3, 'http://localhost:8080\media\normal\Chưởng Tâm\Chưởng Tâm.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Connection'), 1, 65, 'http://localhost:8080\media\normal\Connection\Connection.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Cây Ô Liu Màu Trắng'), 1, 45, 'http://localhost:8080\media\normal\Cây Ô Liu Màu Trắng\Cây Ô Liu Màu Trắng - Tập 1.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO movies (title, description, release_date, runtime, nation_id, poster_url, trailer_url) VALUES ('Cửa Hàng Ánh Sáng', 'Không có nội dung phim', '2024-01-01', 8, (SELECT nation_id FROM nations WHERE name = 'Phim Hàn Quốc'), 'http://localhost:8080\media\normal\Cửa Hàng Ánh Sáng\light shop.png', 'http://localhost:8080\media\normal\Cửa Hàng Ánh Sáng\Cửa Hàng Ánh Sáng - Trailer.mp4') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Cửa Hàng Ánh Sáng'), 1, 44, 'http://localhost:8080\media\normal\Cửa Hàng Ánh Sáng\Cửa Hàng Ánh Sáng.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
Cả ba hợp tác để điều tra sự thật đằng sau các vụ mất tích, đối mặt với những thế lực ngầm và âm mưu đen tối trong lòng Gangnam.', '2024-01-01', 8, (SELECT nation_id FROM nations WHERE name = 'Phim Hàn Quốc'), 'http://localhost:8080\media\normal\Gangnam B-Side\gangnam b-side.png', 'http://localhost:8080\media\normal\Gangnam B-Side\Gangnam B-Side - Trailer.mp4') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Gangnam B-Side'), 1, 49, 'http://localhost:8080\media\normal\Gangnam B-Side\Gangnam B-Side.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Godzilla vs Kong The New Empire'), 1, 3, 'http://localhost:8080\media\normal\Godzilla vs Kong The New Empire\Godzilla vs Kong The New Empire.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Halo'), 1, 2, 'http://localhost:8080\media\normal\Halo\Halo.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Hỏi Các Vì Sao'), 1, 75, 'http://localhost:8080\media\normal\Hỏi Các Vì Sao\Hỏi Các Vì Sao.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Lưu Thủy Điều Điều'), 1, 44, 'http://localhost:8080\media\normal\Lưu Thủy Điều Điều\Lưu Thủy Điều Điều.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
...
Tập 3 sẽ thảo luận về một phần lớn của cánh máy bay dạt vào bờ biển ngoài khơi Bờ biển Đông Phi được xác nhận là của chiếc máy bay mất tích.', '2023-01-01', 3, (SELECT nation_id FROM nations WHERE name = 'Phim Âu Mỹ'), 'http://localhost:8080\media\normal\MH370 Chiếc Bay Biến Mất\mh370.png', '') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'MH370 Chiếc Bay Biến Mất'), 1, 2, 'http://localhost:8080\media\normal\MH370 Chiếc Bay Biến Mất\MH370 Chiếc Bay Biến Mất.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Mạn Ảnh Tầm Trung'), 1, 38, 'http://localhost:8080\media\normal\Mạn Ảnh Tầm Trung\Mạn Ảnh Tầm Trung.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Ngày Của Chó Rừng'), 1, 57, 'http://localhost:8080\media\normal\Ngày Của Chó Rừng\Ngày Của Chó Rừng.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Cổ Trang') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Ngũ Phúc Lâm Môn'), 1, 3, 'http://localhost:8080\media\normal\Ngũ Phúc Lâm Môn\Ngũ Phúc Lâm Môn.mp4');
INSERT INTO nations (name) VALUES ('Phim Nhật Bản') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hoạt Hình') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'One Piece'), 1, 25, 'http://localhost:8080\media\normal\One Piece\One Piece.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Panchiko'), 1, 55, 'http://localhost:8080\media\normal\Panchiko\Panchiko.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hài Hước') ON CONFLICT DO NOTHING;
...
INSERT INTO movies (title, description, release_date, runtime, nation_id, poster_url, trailer_url) VALUES ('Phải Lòng Tình Địch', 'Không có nội dung phim', '2024-01-01', 12, (SELECT nation_id FROM nations WHERE name = 'Phim Hàn Quốc'), 'http://localhost:8080\media\normal\Phải Lòng Tình Địch\phai long tinh dich.png', 'http://localhost:8080\media\normal\Phải Lòng Tình Địch\Phải Lòng Tình Địch - Trailer.mp4') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Phải Lòng Tình Địch'), 1, 66, 'http://localhost:8080\media\normal\Phải Lòng Tình Địch\Phải Lòng Tình Địch.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Cổ Trang') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Sao Địch Nổi Sắc Đẹp Tuyệt Trần'), 1, 2, 'http://localhost:8080\media\normal\Sao Địch Nổi Sắc Đẹp Tuyệt Trần\Sao Địch Nổi Sắc Đẹp Tuyệt Trần.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Secret Level'), 1, 16, 'http://localhost:8080\media\normal\Secret Level\Secret Level.mp4');
INSERT INTO nations (name) VALUES ('Phim Nhật Bản') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Skull Island'), 1, 2, 'http://localhost:8080\media\normal\Skull Island\Skull Island.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Sonic Prime 2'), 1, 24, 'http://localhost:8080\media\normal\Sonic Prime 2\Sonic Prime 2.mp4');
INSERT INTO nations (name) VALUES ('Phim Hàn Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Squid Game 2'), 1, 65, 'http://localhost:8080\media\normal\Squid Game 2\Squid Game 2.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
Một điểm nhấn quan trọng từ phần phụ ""Gen V"" được mang sang, liên quan đến một loại virus có khả năng làm suy yếu các Supes. Cùng PhimMoi theo dõi bộ phim hài ""dark"" này với những pha vietsub táo bạo đến từ subteam của chúng tôi.', '2024-01-01', 8, (SELECT nation_id FROM nations WHERE name = 'Phim Âu Mỹ'), 'http://localhost:8080\media\normal\The Boys 4\the boys 4.png', 'http://localhost:8080\media\normal\The Boys 4\The Boys 4 - Trailer.mp4') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'The Boys 4'), 1, 65, 'http://localhost:8080\media\normal\The Boys 4\The Boys 4.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'The Old Man 2'), 1, 48, 'http://localhost:8080\media\normal\The Old Man 2\The Old Man 2.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'The Penguin'), 1, 66, 'http://localhost:8080\media\normal\The Penguin\The Penguin.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
Đằng sau hậu trường, phần 3 tạo bối cảnh cho một số thay đổi *chính* trong sê-ri. Cụ thể, đây là loạt phim cuối cùng có sự góp mặt của Henry Cavill trong vai Liam Hemsworth sẽ đảm nhận vai diễn của anh ấy trong phần 4 .', '2023-01-01', 8, (SELECT nation_id FROM nations WHERE name = 'Phim Âu Mỹ'), 'http://localhost:8080\media\normal\The Witcher\the witcher 3.png', '') RETURNING movie_id;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Toàn Chức Pháp Sư'), 1, 20, 'http://localhost:8080\media\normal\Toàn Chức Pháp Sư\Toàn Chức Pháp Sư.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hoạt Hình') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Twilight of the Gods'), 1, 33, 'http://localhost:8080\media\normal\Twilight of the Gods\Twilight of the Gods.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hành Động') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Venom 3'), 1, 3, 'http://localhost:8080\media\normal\Venom 3\Venom 3.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hoạt Hình') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'What If 2'), 1, 29, 'http://localhost:8080\media\normal\What If 2\What If 2.mp4');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hoạt Hình') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Xứ Sở Các Nguyên Tố'), 1, 101, 'http://localhost:8080\media\normal\Xứ Sở Các Nguyên Tố\Xứ Sở Các Nguyên Tố.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Đông Chí'), 1, 37, 'http://localhost:8080\media\normal\Đông Chí\Đông Chí.mp4');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Tình Cảm') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = '101 Lần Hôn Nhân Cưỡng Ép'), 1, 37, 'http://localhost:8080\hls/101 Lần Hôn Nhân Cưỡng Ép/epi_num1/master.m3u8');
INSERT INTO nations (name) VALUES ('Phim Âu Mỹ') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Hoạt Hình') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Anime') ON CONFLICT DO NOTHING;
...
INSERT INTO episodes (movie_id, episode_number, runtime, url_video) VALUES ((SELECT movie_id FROM movies WHERE title = 'Arcane (Liên Minh Huyền Thoại)'), 1, 37, 'http://localhost:8080\hls/Arcane (Liên Minh Huyền Thoại)/epi_num1/master.m3u8');
INSERT INTO nations (name) VALUES ('Phim Trung Quốc') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Cổ Trang') ON CONFLICT DO NOTHING;
INSERT INTO genres (name) VALUES ('Phim Thần Thoại') ON CONFLICT DO NOTHING;
